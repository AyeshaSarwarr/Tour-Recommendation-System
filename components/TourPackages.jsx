...
const TourPackages = () => {
    const packages = [
        {
            image: "src/assets/images/swat.jpg",
            alt: "Swat Valley",
            flag: "src/assets/images/swiss.png",
            days: "8 Days",
        ...
        {
            image: "src/assets/images/Amazon.jpg",
            alt: "Amazon",
            flag: "src/assets/images/brazil.png",
            days: "8 Days",
        ...
        {
            image: "src/assets/images/giza.jpg",
            alt: "Giza",
        ...
        <div className="container">
            <section className="tour-packages">
                <h2 className="section-title">
                    <span className="trendy">TRENDY</span><br />
                    ...
                    {packages.map((pkg, index) => (
                        <div key={index} className="package-card">
                            ...
                            <div className="package-info">
                                ...
                                <p className="details"><i className="fa fa-calendar"></i> {pkg.days} &nbsp; <i className="fa fa-user"></i> {pkg.people}</p>
                                <h3>{pkg.name}</h3>
                                <p className="location"><i className="fa fa-map-marker-alt"></i> {pkg.location}</p>
                                <p className="price">
